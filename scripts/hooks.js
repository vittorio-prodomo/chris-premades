...
import {maneuverOptionsUsageCard} from './macros/2024/classFeatures/fighter/battleMaster/maneuvers.js';
export function registerHooks() {
    ...
    // T232: a maneuver used as an activity of "Maneuver Options" gets its own card.
    Hooks.on('dnd5e.preCreateUsageMessage', maneuverOptionsUsageCard);
